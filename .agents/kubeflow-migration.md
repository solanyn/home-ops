# Kubeflow Migration Plan

Migration from Istio-based Kubeflow to Istio-less Kubeflow using Envoy Gateway and app-template HelmReleases.

Each component is versioned independently - we're no longer tied to monolithic platform releases. Renovate tracks each component's latest version.
        ...
        containers:
          app:
            image:
              ...
              tag: v1.10.0  # Renovate tracks latest
            env:
...
- [Kubeflow Component Repos](https://github.com/kubeflow) - each component versioned independently
